/*
  # Add Description Field to Hybrid Search

  1. Changes
    - Add keyword matching on description field
    - Boost +0.25 for matches in description (between display_name and hierarchical_context)
  
  2. Purpose
    - Enable searches like "taylor swift" to match "NFL Swifties" (which mentions Taylor Swift in description)
    - Improve relevance by considering full text content
*/
