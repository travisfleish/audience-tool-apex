/*
  # Update Generate Embeddings Function

  1. Function Updates
    - Modified to call OpenAI API directly using pg_net
    - Reads OpenAI API key from app.openai_api_key setting
    - Uses text-embedding-3-small model with 384 dimensions
    - Processes audiences in batches of 100

  2. Notes
    - Requires pg_net extension for HTTP requests
    - API key must be set using: ALTER DATABASE postgres SET app.openai_api_key = 'your-key';
*/
