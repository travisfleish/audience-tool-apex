/*
  # Remove season column from hybrid_semantic_search function

  1. Changes
    - Drop and recreate hybrid_semantic_search function without season column
    - Remove season from return table definition
    - Remove season from SELECT statements
  
  2. Purpose
    - Fix error after season column was dropped from audiences table
*/
