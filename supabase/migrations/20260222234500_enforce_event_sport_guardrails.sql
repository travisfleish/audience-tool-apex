/*
  # Enforce Event Sport Guardrails In Hybrid Search

  1. Changes
    - Replaces 8-parameter `hybrid_semantic_search` function with sport guardrails.
    - When one or more `season_event_keys` are selected, audiences explicitly tied to
      a different sport are excluded.
    - Non-sports/general audiences remain eligible.

  2. Rationale
    - Prevent cross-sport leakage (e.g., basketball/baseball results for CFP).
    - Keep broad, non-sport audiences (for school/brand/lifestyle context).
*/
