...
import { EquativHome } from './pages/EquativHome';
...
import { equativConfig } from './config';
...
export function EquativApp() {
  ...
  const handleDownloadAllAudiences = () => {
    ...
    link.href = url;
    link.download = equativConfig.allAudiencesCsvFilename;
    link.click();
