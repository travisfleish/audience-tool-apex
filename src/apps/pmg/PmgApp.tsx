...
import { PmgHome } from './pages/PmgHome';
import { PmgNotebook } from './pages/PmgNotebook';
...
export function PmgApp() {
  ...
  const handleDownloadAllAudiences = () => {
    ...
    link.href = url;
    link.download = pmgConfig.allAudiencesCsvFilename;
    link.click();
